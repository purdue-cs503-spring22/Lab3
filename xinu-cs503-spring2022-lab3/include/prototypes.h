...
/* in file disk.c */
extern  int32   flush(void);

/* in file disk.c */
extern  int32 	disk(void);

/* in file inject_failure.c */
extern  int32  	inject_failure(void);
...
/* in file fs_admin_format.c */
extern	int	fs_admin_format(void);

/* in file fs_admin_mount.c */
extern	int	fs_admin_mount(void);

/* in file fs_open.c */
extern	int	fs_open(char *, char *);

/* in file fs_read.c */
extern	int	fs_read(int, char *, int);

/* in file fs_write.c */
extern	int	fs_write(int, char *, int);

/* in file fs_close.c */
extern	int	fs_close(int);

/* in file fs_delete.c */
extern	int	fs_delete(char *);

/* in file fs_ltell.c */
extern	int	fs_ltell(int);

/* in file fs_lseek.c */
extern 	int	fs_lseek(int, int);

/* in file fs_dirlist.c */
extern	int	fs_dirlist(char *, char *, int);

/* in file fs_sync.c */
extern 	int	fs_sync(void);

/* in file fs_ioctl.c */
extern 	int 	fs_ioctl(int);   
...
/* in file disk.c */
extern  int32	get_disk_size(void);
...
/* in file disk.c */
extern  int32 	read_sector(int32, char*);
...
/* in file disk.c */
extern  int32 	write_sector(int32, char *);
